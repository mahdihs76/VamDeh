...
public class GetTrustRequestsAsRequesterResponse extends BaseResponse {
    ...
    public GetTrustRequestsAsRequesterResponse(String id, TrustObject trustier, TrustObject trusted, boolean isTrustRequest, String status, boolean isActive, int activeTrustValue, String description, String requestTime, boolean hasGraphEdge) {
        this.id = id;
